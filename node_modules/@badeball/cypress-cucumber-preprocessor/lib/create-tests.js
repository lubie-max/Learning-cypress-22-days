    ...
    afterEach(function () {
        ...
        if (remainingSteps.length > 0) {
            if (((_a = this.currentTest) === null || _a === void 0 ? void 0 : _a.state) === "failed") {
                ...
                for (const skippedStep of remainingSteps) {
                    const testStepId = (0, assertions_1.assertAndReturn)((_o = (_m = skippedStep.hook) === null || _m === void 0 ? void 0 : _m.id) !== null && _o !== void 0 ? _o : (_p = skippedStep.pickleStep) === null || _p === void 0 ? void 0 : _p.id, "Expected a step to either be a hook or a pickleStep");
                    messages.push({
                        testStepStarted: {
                            testStepId,
                            testCaseStartedId,
